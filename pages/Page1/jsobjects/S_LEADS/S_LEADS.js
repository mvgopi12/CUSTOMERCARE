export default {
	...
	Followups_Leads:()=>{
		...
		{
			if(LEADS.data[i].REMARK=="INTERESTED" || LEADS.data[i].REMARK=="SWITCH OFF/NOT REACHBLE" || LEADS.data[i].REMARK=="CUSTOMER DISCONNECTING" || LEADS.data[i].REMARK=="CUSTOMER WILL CALLBACK" && LEADS.data[i].ACTIVE==true)
			{
				data.push(LEADS.data[i]);
			}
		}
